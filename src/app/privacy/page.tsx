  ...
  return (
    ...
    >
      ...
      <section style={{ marginTop: 20 }}>
        ...
        <p style={{ fontSize: 14, marginTop: 8 }}>
          「课程报告」功能借助大语言模型服务（默认 Claude API，由 Anthropic
          提供；也可能配置为其他供应商）辅助起草报告文本。相关处理可能在加拿大境外（如美国，或按配置在其他司法辖区）进行。
          在将数据发送至该等服务前，我们会对学生姓名进行脱敏处理；出勤率、成绩等数字始终由本系统在本地计算与渲染，
          不交由人工智能生成。我们仍对您的个人信息负责，并通过合同等方式要求受托方提供与本告知相当的保护；
          机构在首次使用该功能前须确认知悉此项跨境处理。
        </p>
      </section>
